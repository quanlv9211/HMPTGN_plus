...
#parser.add_argument('--fixed_curvature', type=bool, default=True, help='fixed (True) curvature or not (False)')
parser.add_argument('--max_curvature', type=float, default=5.0, help='max value of c')
parser.add_argument('--min_curvature', type=float, default=0.01, help='min value of c')
parser.add_argument('--aggregation', type=str, default='deg', help='aggregation method: [deg, att]')
parser.add_argument('--hmp_casual_conv_depth', type=int, default=2, 
                    help='number of hmp temporal casual convolution layers')
parser.add_argument('--hmp_casual_conv_kernel_size', type=int, default=2,
                    help='hmp temporal casual convolution kernel size')
parser.add_argument('--spatial_order', type=int, default=2, help='spatial order')
parser.add_argument('--checkpoint_path', type=str, default='', help='link to check point')
